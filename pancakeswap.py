...
class PankCakeSwap:
    ...
    def swapExactETHForTokens(self,value,amountMin,path):
        ...
        to = self.account
        tx = self.pancake_router.functions.swapExactETHForTokensSupportingFeeOnTransferTokens(
            amountMin,
            path,
            to,
            deadline
    ...
    def swapExactTokensForETH(self,amount,amountMin,path):
        ...
        deadline = int(time.time() + 300)
        to = self.account
        tx = self.pancake_router.functions.swapExactTokensForETHSupportingFeeOnTransferTokens(
        amount,
        amountMin, 
        path, 
        to,
